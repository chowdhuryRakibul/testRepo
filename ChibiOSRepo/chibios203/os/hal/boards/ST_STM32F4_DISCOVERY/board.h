 ...
 * PC8  - SDIO                      (alternate 12).
 * PC9  - SDIO                      (alternate 12).
 * PC10 - SDIO                      (alternate 12).
 * PC11 - SDIO                      (alternate 12).
 * PC12 - SDIO                      (alternate 12).
...
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_FLOATING(GPIOC_OTG_FS_POWER_ON) |\
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOC_SCLK) |       \
                                     PIN_PUPDR_PULLUP(GPIOC_PIN11) |        \
                                     PIN_PUPDR_PULLUP(GPIOC_SDIN) |       \
...
#define VAL_GPIOC_AFRH              (PIN_AFIO_AF(GPIOC_PIN8, 12U) |          \
                                     ...
                                     PIN_AFIO_AF(GPIOC_SCLK, 12U) |          \
                                     PIN_AFIO_AF(GPIOC_PIN11, 12U) |         \
                                     PIN_AFIO_AF(GPIOC_SDIN, 12U) |          \
